...
const MainBody = () => {
    ...
    return (
        ...
        <div className='flex justify-center items-center h-full w-full bg-üstgri '>
            <div className='flex flex-col justify-center items-center h-full w-full container'>
                ...
                <div className='flex justify-center items-center h-full w-full my-[2rem]'>
                    <ul className='font-bold text-stone-700 flex justify-around items-center h-full w-[30%] '>
                ...
                <div className='flex justify-center items-center h-full w-[80%] '>
                    <div className={`${x} duration-1000`}><Surgery sayi1={a} sayi2={b} sayi3={c} yol={yol} /></div>
                    <div className={`${y} duration-1000`}><Surgerymeme sayi1={a} sayi2={b} sayi3={c} yol={yol} /></div>
                    <div className={`${z} duration-1000`}><Surgeryvucut sayi1={a} sayi2={b} sayi3={c} yol={yol} /></div>
                ...
                {/*  */}
                <div className='flex justify-center items-center h-full w-full my-[2rem]'>
                    <ul className='flex justify-around items-center h-full w-[7%] '>
                        <li onClick={tts_bir} className={` cursor-pointer flex justify-center items-center w-[0.7rem] h-[0.7rem] rounded-full duration-500 bg-karelaci ${althizmet1 ? "border-[0.1rem] border-black" : ""}`}></li>
                        <li onClick={tts_iki} className={`cursor-pointer flex justify-center items-center w-[0.7rem] h-[0.7rem] rounded-full duration-500 bg-karelaci ${althizmet2 ? "border-[0.1rem] border-black" : ""}`}></li>
                        <li onClick={tts_uc} className={`cursor-pointer flex justify-center items-center w-[0.7rem] h-[0.7rem] rounded-full duration-500 bg-karelaci ${althizmet3 ? "border-[0.1rem] border-black" : ""}`}></li>
